...
| **KWIC (Legacy)** | registered | Concordance search over a live XML parse; word or phrase, context window 1–15, sortable by left/right/file, paginated, each line attributed to its file | `main/views.py` (`kwic`, `_kwic_results`), `main/templates/main/kwic.html` |
